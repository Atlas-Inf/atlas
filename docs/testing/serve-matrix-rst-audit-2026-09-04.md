...
Examined Atlas-Inf `main` at `6c5f17dab`. This tranche changes the Python release
harness and its checks. It changes no inference, model, kernel, or Rust code.
...
The existing gate source was byte-identical on the examined historical Avarok
revision `567b5ebe7` and Atlas-Inf revision `6c5f17dab` (SHA256
...
Observed on macOS arm64 with Python 3.14.6:
