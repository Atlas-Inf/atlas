...
- **If you're a hardware vendor** — the abstractions that let a new GPU family plug in are two traits (`ComputeTarget`, `GpuBackend`) plus kernel source. See [Adding a new hardware target](https://github.com/Atlas-Inf/atlas/blob/main/README.md#adding-a-new-hardware-target) in the README.
