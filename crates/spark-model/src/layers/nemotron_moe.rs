...
pub struct NemotronMoeLayer {
    ...
    moe_expert_gemv_wide_grouped_small_k: KernelHandle,
    moe_expert_gemv_wide_grouped_large_k: KernelHandle,
    moe_expert_build_large_list_k: KernelHandle,
...
impl NemotronMoeLayer {
    pub fn new(
        ...
        Ok(Self {
            ...
            moe_expert_gemv_wide_grouped_small_k: super::try_kernel(
                gpu,
                "moe_expert_gemv_wide_grouped",
                "moe_expert_gemv_wide_grouped_small",
            ),
            moe_expert_gemv_wide_grouped_large_k: super::try_kernel(
                gpu,
                "moe_expert_gemv_wide_grouped",
                "moe_expert_gemv_wide_grouped_large",
            ),
            moe_expert_build_large_list_k: super::try_kernel(
                gpu,
                "moe_expert_gemv_wide_grouped",
                "moe_expert_build_large_list",
            ),
