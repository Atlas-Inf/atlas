...
fn zero_head() -> BlockDiffusionDraftHead {
    BlockDiffusionDraftHead {
        ...
        batch_fc_norm: DevicePtr(0),
        batch_norm: DevicePtr(0),
        batch_q: DevicePtr(0),
        batch_k: DevicePtr(0),
        batch_v: DevicePtr(0),
        ...
        batch_mlp_gate: DevicePtr(0),
        batch_mlp_up: DevicePtr(0),
        ...
        graph_runtime: zero_graph_runtime(),
...
fn zero_graph_runtime() -> std::sync::Arc<spark_runtime::graph_runtime::GraphRuntime> {
...
fn zero_kernels() -> DflashKernels {
    ...
    DflashKernels {
        ...
        argmax_batch: zero,
        batched_embed: zero,
        batch_anchor_add: zero,
        batch_markov_add_bias: zero,
        batch_markov_store_tokens: zero,
        fill_slots: zero,
        prefill_attn: zero,
