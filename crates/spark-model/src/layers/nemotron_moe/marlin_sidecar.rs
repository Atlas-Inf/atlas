...
impl MarlinSidecar {
    pub fn try_build(
        ...
        Ok(Some(Self {
            ...
            slot_a: gpu.alloc(ops::MARLIN_SLOTS as usize * ops::MARLIN_M_TILE as usize * up_k * 2)?,
            slot_up: gpu.alloc(ops::MARLIN_SLOTS as usize * ops::MARLIN_M_TILE as usize * up_n * 2)?,
            slot_dn: gpu.alloc(
                ops::MARLIN_SLOTS as usize * ops::MARLIN_M_TILE as usize * down_n * 2,
            )?,
